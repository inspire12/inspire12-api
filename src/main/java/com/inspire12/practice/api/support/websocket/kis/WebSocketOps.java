package com.inspire12.practice.api.support.websocket.kis;
...
public class WebSocketOps {
     ...
     * trKey = "005930"; // stock code String htsId = "101334"; // hts id
     */
    ...
    private static final String sMessage = "static message";
    ...
    public static void main(String[] args) {
        try {
            ...
            stockCode = prop.getProperty("trKey");
    ...
    private void showMessage() {
        ...
        //'{"header":{"authoriztion":"","appkey":"' + g_appkey + '","appsecret":"' + g_appseceret + '","personalseckey":"' + g_personalsecKey + '","custtype":"P","tr_type":"' + tr_type + '","content-type":"utf-8"},"body":{"input":{"tr_id":"' + tr_id + '","tr_key":"' + trKey + '"}}}'
